...
@call clipboardresizeA32.exe remove
...
@"C:\Program Files\AutoHotkey\Compiler\Ahk2Exe.exe" /in clipboardresize.ahk /out clipboardresizeA32.exe /icon clipboardresize.ico /bin "C:\Program Files\AutoHotkey\Compiler\Ansi 32-bit.bin"